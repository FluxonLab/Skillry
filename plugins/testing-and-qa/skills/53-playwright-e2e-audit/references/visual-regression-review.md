...
> **Provenance.** Absorbed into `playwright-e2e-audit` in Skillry 3.0.0. Formerly the standalone skill `visual-regression-review` (`plugins/testing-and-qa/skills/56-visual-regression-review/SKILL.md`). Origin: Skillry original, MIT (repository `LICENSE`).
>
> **Changes:** frontmatter converted to this header.
>
> **Former trigger:** Use when you need to review screenshots, layout diffs, visual states, responsive snapshots, and rendering drift.
