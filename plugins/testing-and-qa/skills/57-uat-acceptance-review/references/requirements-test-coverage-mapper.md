...
> **Reference of `uat-acceptance-review`.** Formerly the standalone skill `requirements-test-coverage-mapper`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [jaktestowac/awesome-copilot-for-testers](https://github.com/jaktestowac/awesome-copilot-for-testers); previously `community/jaktestowac-awesome-copilot-for-testers/skills/requirements-test-coverage-mapper/`.
> - License: MIT (upstream `LICENSE` checked 2026-09-19, blob 89bc5e96, identical to the vendored copy); copy kept at [requirements-test-coverage-mapper/LICENSE](requirements-test-coverage-mapper/LICENSE).
