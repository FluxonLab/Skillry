...
> **Reference of `uat-acceptance-review`.** Formerly the standalone skill `test-scenarios`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [phuryn/pm-skills](https://github.com/phuryn/pm-skills) `pm-execution/skills/test-scenarios/SKILL.md` at commit 8607e3b077817f89bf4a9b623246219734ac3be0 (byte-identical, blob d5a25a71); imported from a local unmanaged install.
> - License: MIT, Copyright (c) 2026 Pawel Huryn (upstream `LICENSE` checked 2026-09-19, blob f6eca502); copy kept at [test-scenarios/LICENSE](test-scenarios/LICENSE).
