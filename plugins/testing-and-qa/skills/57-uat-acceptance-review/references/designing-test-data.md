...
> **Reference of `uat-acceptance-review`.** Formerly the standalone skill `designing-test-data`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [jaktestowac/awesome-copilot-for-testers](https://github.com/jaktestowac/awesome-copilot-for-testers); previously `community/jaktestowac-awesome-copilot-for-testers/skills/designing-test-data/`.
> - License: MIT (upstream `LICENSE` checked 2026-09-19, blob 89bc5e96, identical to the vendored copy); copy kept at [designing-test-data/LICENSE](designing-test-data/LICENSE).
...
- `designing-functional-tests` ([reference](designing-functional-tests.md)) - when the data pack should map directly to scenarios or cases
