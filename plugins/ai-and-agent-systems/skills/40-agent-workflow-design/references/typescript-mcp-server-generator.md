...
> **Former skill `typescript-mcp-server-generator`:** Generate a complete MCP server project in TypeScript with tools, resources, and proper configuration
> **Provenance:** third-party, from [github/awesome-copilot](https://github.com/github/awesome-copilot) (upstream path today: `skills/typescript-mcp-server-generator/SKILL.md`), vendored into Skillry on 2026-05-31 as `community/github-awesome-copilot/skills/typescript-mcp-server-generator/SKILL.md`. Copyright GitHub, Inc. MIT License: [typescript-mcp-server-generator/LICENSE](typescript-mcp-server-generator/LICENSE). Changes: frontmatter and vendor note turned into this header; body unchanged. This is the 2026-05-31 snapshot; upstream has changed since.
