...
> **Former skill `python-mcp-server-generator`:** Generate a complete MCP server project in Python with tools, resources, and proper configuration
> **Provenance:** third-party, from [github/awesome-copilot](https://github.com/github/awesome-copilot) (upstream path today: `skills/python-mcp-server-generator/SKILL.md`), vendored into Skillry on 2026-05-31 as `community/github-awesome-copilot/skills/python-mcp-server-generator/SKILL.md`. Copyright GitHub, Inc. MIT License: [python-mcp-server-generator/LICENSE](python-mcp-server-generator/LICENSE). Changes: frontmatter and vendor note turned into this header; body unchanged. This is the 2026-05-31 snapshot; upstream has changed since.
