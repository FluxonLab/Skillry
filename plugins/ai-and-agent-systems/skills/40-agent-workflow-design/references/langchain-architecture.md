> **Reference of [`agent-workflow-design`](../SKILL.md)** (merged in Skillry 3.0.0).
> **Former skill `langchain-architecture`:** Design LLM applications using LangChain 1.x and LangGraph for agents, memory, and tool integration. Use when building LangChain applications, implementing AI agents, or creating complex LLM workflows.
> **Provenance:** third-party, from [wshobson/agents](https://github.com/wshobson/agents) (upstream path today: `plugins/llm-application-dev/skills/langchain-architecture/SKILL.md`), vendored into Skillry on 2026-05-31 as `community/wshobson-agents/skills/langchain-architecture/SKILL.md`. Copyright (c) 2024 Seth Hobson. MIT License: [langchain-architecture/LICENSE](langchain-architecture/LICENSE). Changes: frontmatter and vendor note turned into this header; body unchanged. This is the 2026-05-31 snapshot; upstream has changed since.
