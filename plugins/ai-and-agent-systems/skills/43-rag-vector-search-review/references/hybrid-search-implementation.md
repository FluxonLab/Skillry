...
> **Former skill `hybrid-search-implementation`:** Combine vector and keyword search for improved retrieval. Use when implementing RAG systems, building search engines, or when neither approach alone provides sufficient recall.
> **Provenance:** third-party, from [wshobson/agents](https://github.com/wshobson/agents) (upstream path today: `plugins/llm-application-dev/skills/hybrid-search-implementation/SKILL.md`), vendored into Skillry on 2026-05-31 as `community/wshobson-agents/skills/hybrid-search-implementation/SKILL.md`. Copyright (c) 2024 Seth Hobson. MIT License: [hybrid-search-implementation/LICENSE](hybrid-search-implementation/LICENSE). Changes: frontmatter and vendor note turned into this header; body unchanged. This is the 2026-05-31 snapshot; upstream has changed since.
