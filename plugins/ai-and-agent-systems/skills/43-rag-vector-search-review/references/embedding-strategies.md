...
> **Former skill `embedding-strategies`:** Select and optimize embedding models for semantic search and RAG applications. Use when choosing embedding models, implementing chunking strategies, or optimizing embedding quality for specific domains.
> **Provenance:** third-party, from [wshobson/agents](https://github.com/wshobson/agents) (upstream path today: `plugins/llm-application-dev/skills/embedding-strategies/SKILL.md`), vendored into Skillry on 2026-05-31 as `community/wshobson-agents/skills/embedding-strategies/SKILL.md`. Copyright (c) 2024 Seth Hobson. MIT License: [embedding-strategies/LICENSE](embedding-strategies/LICENSE). Changes: frontmatter and vendor note turned into this header; body unchanged. This is the 2026-05-31 snapshot; upstream has changed since.
