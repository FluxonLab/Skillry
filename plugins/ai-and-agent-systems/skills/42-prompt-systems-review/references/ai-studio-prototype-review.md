...
> **Former skill `ai-studio-prototype-review`:** Use when you need to review AI studio prototypes, prompt tooling, agent playgrounds, and rapid product experiments.
> **Provenance:** Skillry original, moved from `plugins/optional-specialist/skills/80-ai-studio-prototype-review/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
...
- The system is already in production — use the main `prompt-systems-review` procedure ([../SKILL.md](../SKILL.md)) or `ai-security-review` for production reviews.
