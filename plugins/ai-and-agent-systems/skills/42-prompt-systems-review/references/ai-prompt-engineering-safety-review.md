...
> **Former skill `ai-prompt-engineering-safety-review`:** Comprehensive AI prompt engineering safety review and improvement prompt. Analyzes prompts for safety, bias, security vulnerabilities, and effectiveness while providing detailed improvement recommendations with extensive frameworks, testing methodologies, and educational content.
> **Provenance:** third-party, from [github/awesome-copilot](https://github.com/github/awesome-copilot) (upstream path today: `skills/ai-prompt-engineering-safety-review/SKILL.md`), vendored into Skillry on 2026-05-31 as `community/github-awesome-copilot/skills/ai-prompt-engineering-safety-review/SKILL.md`. Copyright GitHub, Inc. MIT License: [ai-prompt-engineering-safety-review/LICENSE](ai-prompt-engineering-safety-review/LICENSE). Changes: frontmatter and vendor note turned into this header; body unchanged. This is the 2026-05-31 snapshot; upstream has changed since.
