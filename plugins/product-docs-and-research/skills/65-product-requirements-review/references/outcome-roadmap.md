...
> **Former skill `outcome-roadmap`:** Transform an output-focused roadmap into an outcome-focused one that communicates strategic intent. Rewrites initiatives as outcome statements reflecting user and business impacts. Use when shifting to outcome roadmaps, making a roadmap more strategic, or rewriting feature lists as outcomes.
> **Provenance:** third-party, from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) at commit `8607e3b07781` (`pm-execution/skills/outcome-roadmap/SKILL.md`, sha256 `3d2da8f82f4cbe4c`), imported 2026-09-19. Copyright (c) 2026 Pawel Huryn. MIT License: [outcome-roadmap/LICENSE](outcome-roadmap/LICENSE). Changes: frontmatter turned into this header.
> **Note:** `$ARGUMENTS` is the team or product the user named.
