> **Reference of [`product-requirements-review`](../SKILL.md)** (merged in Skillry 3.0.0).
> **Former skill `prioritize-features`:** Prioritize a backlog of feature ideas based on impact, effort, risk, and strategic alignment with top 5 recommendations. Use when prioritizing a feature backlog, making scope decisions, or ranking product ideas.
> **Provenance:** third-party, from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) at commit `8607e3b07781` (`pm-product-discovery/skills/prioritize-features/SKILL.md`, sha256 `d05c001ea9d71ccf`), imported 2026-09-19. Copyright (c) 2026 Pawel Huryn. MIT License: [prioritize-features/LICENSE](prioritize-features/LICENSE). Changes: frontmatter turned into this header.
> **Note:** `$ARGUMENTS` is the product or backlog the user named. The `prioritization-frameworks` skill it mentions is an upstream pm-skills skill that Skillry does not ship.
