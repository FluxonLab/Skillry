...
> **Former skill `pre-mortem`:** Run a pre-mortem risk analysis on a PRD or launch plan. Categorizes risks as Tigers (real problems), Paper Tigers (overblown concerns), and Elephants (unspoken worries), then classifies as launch-blocking, fast-follow, or track. Use when preparing for launch, stress-testing a product plan, or identifying what could go wrong.
> **Provenance:** third-party, from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) at commit `8607e3b07781` (`pm-execution/skills/pre-mortem/SKILL.md`, sha256 `4e5cf10a46ac1d1c`), imported 2026-09-19. Copyright (c) 2026 Pawel Huryn. MIT License: [pre-mortem/LICENSE](pre-mortem/LICENSE). Changes: frontmatter turned into this header.
> **Note:** `$ARGUMENTS` is the PRD or launch plan the user named. Companion risk pass: [strategy-red-team.md](strategy-red-team.md).
