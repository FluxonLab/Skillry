...
> **Former skill `north-star-metric`:** Define a North Star Metric and 3-5 supporting input metrics that form a metrics constellation. Classify the business game (Attention, Transaction, Productivity) and validate against 7 criteria for an effective North Star. Use when choosing a North Star Metric, setting up a metrics framework, learning about the North Star Framework, or deciding what to measure.
> **Provenance:** third-party, from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) at commit `8607e3b07781` (`pm-marketing-growth/skills/north-star-metric/SKILL.md`, sha256 `00242397486a88bb`), imported 2026-09-19. Copyright (c) 2026 Pawel Huryn. MIT License: [north-star-metric/LICENSE](north-star-metric/LICENSE). Changes: frontmatter turned into this header.
> **Note:** `$ARGUMENTS` is the product the user named.
