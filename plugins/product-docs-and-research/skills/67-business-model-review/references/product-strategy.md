...
> **Former skill `product-strategy`:** Create a comprehensive product strategy using the 9-section Product Strategy Canvas — vision, segments, costs, value propositions, trade-offs, metrics, growth, capabilities, and defensibility. Use when building a product strategy, creating a strategic plan, or defining product direction.
> **Provenance:** third-party, from [phuryn/pm-skills](https://github.com/phuryn/pm-skills) at commit `8607e3b07781` (`pm-product-strategy/skills/product-strategy/SKILL.md`, sha256 `50d4bfe62ae71a32`), imported 2026-09-19. Copyright (c) 2026 Pawel Huryn. MIT License: [product-strategy/LICENSE](product-strategy/LICENSE). Changes: frontmatter turned into this header.
