...
> **Former skill `changelog-and-release-notes`:** Use when you need to write or audit a CHANGELOG and human-facing release notes — applying Keep a Changelog structure, deriving entries from conventional commits, choosing the correct semver bump, and writing clear breaking-change and migration notes.
> **Provenance:** Skillry original, moved from `plugins/documentation-and-tech-writing/skills/303-changelog-and-release-notes/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
...
- You need full API reference docs (use [api-reference-docs](api-reference-docs.md)) rather than a change summary.
