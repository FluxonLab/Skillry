...
> **Former skill `runbook-and-operational-docs`:** Use when you need to write or audit incident runbooks and on-call operational docs — symptom-first triage, validated diagnostic and recovery commands, escalation paths and severity levels, rollback steps, and verification that service is restored.
> **Provenance:** Skillry original, moved from `plugins/documentation-and-tech-writing/skills/305-runbook-and-operational-docs/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
...
- The need is teaching a concept or normal-usage how-to (use [tutorial-and-how-to-writing](tutorial-and-how-to-writing.md)).
