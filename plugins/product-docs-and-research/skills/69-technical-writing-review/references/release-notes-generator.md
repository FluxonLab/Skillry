...
> **Former skill `release-notes-generator`:** Use when you need to generate concise release notes, known issues, migration notes, and operator actions.
> **Provenance:** Skillry original, moved from `plugins/devops-and-release/skills/61-release-notes-generator/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
