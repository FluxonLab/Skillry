...
> **Former skill `readme-and-docs-structure`:** Use when you need to structure or restructure a project README and a documentation site — defining required sections, a 5-minute quickstart, a navigable table of contents, and a docs-as-code layout that lives in the repo and builds in CI.
> **Provenance:** Skillry original, moved from `plugins/documentation-and-tech-writing/skills/301-readme-and-docs-structure/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
...
- The request is purely about API reference generation (use [api-reference-docs](api-reference-docs.md)) or release notes (use [changelog-and-release-notes](changelog-and-release-notes.md)).
