...
> **Former skill `tutorial-and-how-to-writing`:** Use when you need to write or classify learning-oriented and task-oriented documentation using the Diátaxis framework — separating tutorials, how-to guides, reference, and explanation, and producing runnable, verified step-by-step instructions.
> **Provenance:** Skillry original, moved from `plugins/documentation-and-tech-writing/skills/304-tutorial-and-how-to-writing/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
...
- The need is an exhaustive parameter/endpoint listing (use [api-reference-docs](api-reference-docs.md) — that is the reference quadrant).
- The need is structuring the whole site/README (use [readme-and-docs-structure](readme-and-docs-structure.md)).
