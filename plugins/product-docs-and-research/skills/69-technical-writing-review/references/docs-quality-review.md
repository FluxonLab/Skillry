...
> **Former skill `docs-quality-review`:** Use when you need to review documentation for quality — technical accuracy against the code, audience fit, terminology and style consistency, broken internal/external links, and whether every example actually runs.
> **Provenance:** Skillry original, moved from `plugins/documentation-and-tech-writing/skills/306-docs-quality-review/SKILL.md`. Changes: frontmatter turned into this header; references to skills merged into this hub now link to their reference files.
...
- The task is to author/restructure, not assess (use [readme-and-docs-structure](readme-and-docs-structure.md) or [tutorial-and-how-to-writing](tutorial-and-how-to-writing.md)).
