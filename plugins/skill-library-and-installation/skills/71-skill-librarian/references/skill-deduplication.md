...
> Absorbed into `skill-librarian` in Skillry 3.0.0; formerly the standalone skill `skill-deduplication`.
> Origin: Skillry original, former path `plugins/skill-library-and-installation/skills/72-skill-deduplication/SKILL.md`.
...
- The goal is to find the right skill for a task — use the main `SKILL.md` procedure (skill-librarian).
...
- The goal is to route a task to an agent — use `references/skill-to-agent-router.md`.
