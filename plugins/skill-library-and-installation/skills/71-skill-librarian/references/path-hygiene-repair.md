...
> Absorbed into `skill-librarian` in Skillry 3.0.0; formerly the standalone skill `path-hygiene-repair`.
> Origin: Skillry original, former path `plugins/skill-library-and-installation/skills/75-path-hygiene-repair/SKILL.md`.
...
- The file placement is correct and the issue is malformed content — use `references/global-installation-audit.md` to diagnose.
...
```bash
# Re-run the audit commands from references/global-installation-audit.md Phase 1–3
