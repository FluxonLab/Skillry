...
> **Merged reference.** Former Skillry skill `kubernetes-manifest-review` (`plugins/cloud-and-infrastructure/skills/333-kubernetes-manifest-review/SKILL.md`, Skillry original), merged into `cloud-service-architecture` in Skillry 3.0.0.
>
> **Former description:** Use when you need to review or author Kubernetes manifests or Helm charts for resource requests and limits, liveness/readiness/startup probes, pod security context, RBAC scope, network policy, HPA, secret handling, and common workload anti-patterns.
>
