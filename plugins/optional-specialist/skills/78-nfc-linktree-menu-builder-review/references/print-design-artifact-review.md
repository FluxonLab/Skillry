> **Merged skill:** `print-design-artifact-review` is part of `nfc-linktree-menu-builder-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** Skillry original, formerly `plugins/optional-specialist/skills/83-print-design-artifact-review/SKILL.md`.
> **Changes:** YAML frontmatter replaced by this header; body unchanged.
> **Former description:** Use when you need to review print-ready design artifacts, NFC cards, QR codes, bleed, export formats, and production handoff.
