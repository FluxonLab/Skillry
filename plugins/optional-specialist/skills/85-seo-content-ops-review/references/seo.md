...
> **Reference of `seo-content-ops-review`.** Formerly the standalone skill `seo`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [addyosmani/web-quality-skills](https://github.com/addyosmani/web-quality-skills); previously `community/addyosmani-web-quality-skills/skills/seo/`.
> - License: MIT, Copyright (c) 2026 Addy Osmani (upstream `LICENSE` checked 2026-09-19, blob 90715bb4, identical to the vendored copy); copy kept at [seo/LICENSE](seo/LICENSE).
> - Earlier Skillry import: vendored from `addyosmani-web-quality-skills` on 2026-05-31.
> - Consolidation changes: frontmatter moved into this header; links to the sibling `core-web-vitals` skill now name its new home (the `frontend-performance-budget` skill) and the never-vendored `web-quality-audit` link points upstream; body otherwise unchanged.
...
| Technical SEO | ~15% | ✓ |
| Page experience (Core Web Vitals) | ~10% | See Core Web Vitals (skill `frontend-performance-budget`, reference `core-web-vitals`) |
| On-page SEO | ~10% | ✓ |
...
- Core Web Vitals (skill `frontend-performance-budget`, reference `core-web-vitals`)
