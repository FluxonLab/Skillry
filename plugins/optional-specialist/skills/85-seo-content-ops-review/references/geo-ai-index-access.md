...
> **Reference of `seo-content-ops-review`.** Formerly the standalone skill `geo-ai-index-access`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [TheSmokeDev/geo-skills](https://github.com/TheSmokeDev/geo-skills) `skills/geo-ai-index-access/SKILL.md` at commit 7f3ec21a065a8af39460bcace8bcd723b7d52145 (byte-identical); imported from a local unmanaged install.
> - License: MIT, Copyright (c) 2026 SmokeDev (upstream `LICENSE` checked 2026-09-19, blob 81ad5d5e); copy kept at [geo-ai-index-access/LICENSE](geo-ai-index-access/LICENSE).
