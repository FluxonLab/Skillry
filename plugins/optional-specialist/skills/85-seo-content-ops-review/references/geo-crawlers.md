...
> **Reference of `seo-content-ops-review`.** Formerly the standalone skill `geo-crawlers`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [TheSmokeDev/geo-skills](https://github.com/TheSmokeDev/geo-skills) `skills/geo-crawlers/SKILL.md` at commit 84216387296629d518876c4482f39cb592e5c40e (byte-identical); imported from a local unmanaged install.
> - License: MIT, Copyright (c) 2026 SmokeDev (upstream `LICENSE` checked 2026-09-19, blob 81ad5d5e); copy kept at [geo-crawlers/LICENSE](geo-crawlers/LICENSE).
> - Lineage: this text is a close revision of `skills/geo-crawlers/SKILL.md` in [zubair-trabzada/geo-seo-claude](https://github.com/zubair-trabzada/geo-seo-claude) (MIT, Copyright (c) 2026 Zubair Trabzada, `LICENSE` blob 29ee5a8f); that notice is kept at [geo-crawlers/LICENSE-geo-seo-claude](geo-crawlers/LICENSE-geo-seo-claude).
