...
> **Reference of `seo-content-ops-review`.** Formerly the standalone skill `claude-seo-seo-sxo`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [AgriciDaniel/claude-seo](https://github.com/AgriciDaniel/claude-seo) `skills/seo-sxo/SKILL.md` at commit e46cd59971ec10664047b45a42d9c1ee85f29954 (byte-identical; sidecars matched at the commits recorded for the lock); imported from a local unmanaged install.
> - License: MIT, Copyright (c) 2026 agricidaniel (upstream root `LICENSE` checked 2026-09-19, blob 94fac746, same at the pinned commits); full text at [claude-seo-seo-sxo/LICENSE](claude-seo-seo-sxo/LICENSE).
> - Upstream skill name: `seo-sxo` (original author per metadata: Florian Schmitz). Not imported: `.colaskill/metadata.json` (installer metadata).
...
Read `references/claude-seo-seo-sxo/references/page-type-taxonomy.md` for classification rules.
...
- Classify target page using `references/claude-seo-seo-sxo/references/page-type-taxonomy.md`
...
Read `references/claude-seo-seo-sxo/references/user-story-framework.md` for the full framework.
...
Read `references/claude-seo-seo-sxo/references/persona-scoring.md` for methodology.
...
Read `references/claude-seo-seo-sxo/references/wireframe-templates.md` for templates.
...
Moved to [seo-optional-integrations.md](seo-optional-integrations.md#claude-seo-seo-sxo) during consolidation (optional DataForSEO MCP usage).
