...
> **Reference of `seo-content-ops-review`.** Formerly the standalone skill `seo-page`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [AgriciDaniel/claude-seo](https://github.com/AgriciDaniel/claude-seo) `skills/seo-page/SKILL.md` at commit 2384fdd9429696021d143006a722c7cf1aa76d43 (byte-identical; sidecars matched at the commits recorded for the lock); imported from a local unmanaged install.
> - License: MIT, Copyright (c) 2026 agricidaniel (upstream root `LICENSE` checked 2026-09-19, blob 94fac746, same at the pinned commits); full text at [seo-page/LICENSE](seo-page/LICENSE), upstream per-skill notice at [seo-page/LICENSE.txt](seo-page/LICENSE.txt).
...
Moved to [seo-optional-integrations.md](seo-optional-integrations.md#seo-page) during consolidation (optional DataForSEO MCP usage).
