...
> **Reference of `seo-content-ops-review`.** Formerly the standalone skill `geo-schema`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [TheSmokeDev/geo-skills](https://github.com/TheSmokeDev/geo-skills) `skills/geo-schema/SKILL.md` at commit 9540f9a5b4b757cf9baf308b713a335f0b327c5b (byte-identical); imported from a local unmanaged install.
> - License: MIT, Copyright (c) 2026 SmokeDev (upstream `LICENSE` checked 2026-09-19, blob 81ad5d5e); copy kept at [geo-schema/LICENSE](geo-schema/LICENSE).
> - Lineage: this text is a close revision of `skills/geo-schema/SKILL.md` in [zubair-trabzada/geo-seo-claude](https://github.com/zubair-trabzada/geo-seo-claude) (MIT, Copyright (c) 2026 Zubair Trabzada, `LICENSE` blob 29ee5a8f); that notice is kept at [geo-schema/LICENSE-geo-seo-claude](geo-schema/LICENSE-geo-seo-claude).
