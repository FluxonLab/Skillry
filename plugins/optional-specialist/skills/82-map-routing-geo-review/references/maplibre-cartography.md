...
> Absorbed into `map-routing-geo-review` in Skillry 3.0.0; formerly the standalone skill `maplibre-cartography`.
> Source: [maplibre/maplibre-agent-skills](https://github.com/maplibre/maplibre-agent-skills) at commit `b0a74bb4231709951e12867e00b0842ad9a27c96`, upstream `skills/maplibre-cartography/SKILL.md`.
> License: MIT, Copyright (c) 2026 MapLibre contributors (portions may be adapted from mapbox-agent-skills, MIT, Copyright (c) Mapbox, Inc.). License text and upstream NOTICE are in `references/maplibre-cartography/LICENSE` and `references/maplibre-cartography/NOTICE`.
...
3. Hillshade layers (if any — see maplibre-terrain-patterns, an upstream MapLibre skill not bundled in Skillry, for configuration)
...
- [**maplibre-tile-sources**](maplibre-tile-sources.md) — Setting up glyphs, sprites, and source configuration.
- [**maplibre-pmtiles-patterns**](https://github.com/maplibre/maplibre-agent-skills/tree/b0a74bb4231709951e12867e00b0842ad9a27c96/skills/maplibre-pmtiles-patterns) — Serving imagery (raster) and terrain sources from PMTiles files.
- **maplibre-terrain-patterns** (upstream MapLibre skill, not bundled in Skillry) — Hillshade configuration, multi-pass techniques, 3D terrain, DEM sources.
