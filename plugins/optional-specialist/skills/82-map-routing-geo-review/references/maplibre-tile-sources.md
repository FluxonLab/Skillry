...
> Absorbed into `map-routing-geo-review` in Skillry 3.0.0; formerly the standalone skill `maplibre-tile-sources`.
> Source: [maplibre/maplibre-agent-skills](https://github.com/maplibre/maplibre-agent-skills) at commit `b0a74bb4231709951e12867e00b0842ad9a27c96`, upstream `skills/maplibre-tile-sources/SKILL.md`.
> License: MIT, Copyright (c) 2026 MapLibre contributors (portions may be adapted from mapbox-agent-skills, MIT, Copyright (c) Mapbox, Inc.). License text and upstream NOTICE are in `references/maplibre-tile-sources/LICENSE` and `references/maplibre-tile-sources/NOTICE`.
> Links to sibling MapLibre skills were adjusted: `maplibre-tile-sources` and `maplibre-cartography` are bundled in this directory; the others point to the upstream repository at the pinned commit.
> The upstream directory also held `AGENTS.md`, a condensed quick reference that repeats this file; it was not copied.
...
See [maplibre-pmtiles-patterns](https://github.com/maplibre/maplibre-agent-skills/tree/b0a74bb4231709951e12867e00b0842ad9a27c96/skills/maplibre-pmtiles-patterns) (upstream MapLibre skill) for setup.
...
- [**maplibre-pmtiles-patterns**](https://github.com/maplibre/maplibre-agent-skills/tree/b0a74bb4231709951e12867e00b0842ad9a27c96/skills/maplibre-pmtiles-patterns) — Serverless PMTiles hosting and MapLibre integration.
- **maplibre-style-patterns** — Layer and source configuration for common use cases. (Not yet in repo.)
- [**maplibre-mapbox-migration**](https://github.com/maplibre/maplibre-agent-skills/tree/b0a74bb4231709951e12867e00b0842ad9a27c96/skills/maplibre-mapbox-migration) — Replacing Mapbox tiles with MapLibre-compatible sources.
