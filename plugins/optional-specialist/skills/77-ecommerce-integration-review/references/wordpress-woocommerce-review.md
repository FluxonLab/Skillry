> **Merged skill:** `wordpress-woocommerce-review` is part of `ecommerce-integration-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** Skillry original, formerly `plugins/optional-specialist/skills/76-wordpress-woocommerce-review/SKILL.md`.
> **Changes:** YAML frontmatter replaced by this header; body unchanged.
> **Former description:** Use when you need to review WordPress, WooCommerce, PHP plugin, theme, checkout, payment, and extension changes.
