...
> Absorbed into `cost-control-token-review` in Skillry 3.0.0; formerly the standalone skill `cloud-spend-review`.
> Origin: Skillry original, former path `plugins/performance-and-cost/skills/326-cloud-spend-review/SKILL.md`.
...
- The "cost" is per-token LLM/API billing — use LLM API cost optimization (`references/llm-api-cost-optimization.md`) instead.
