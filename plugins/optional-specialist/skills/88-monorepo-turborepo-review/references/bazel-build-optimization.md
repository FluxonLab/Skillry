...
> **Third-party content.** `bazel-build-optimization` from [wshobson/agents](https://github.com/wshobson/agents), upstream path `plugins/developer-essentials/skills/bazel-build-optimization/SKILL.md`. MIT License, Copyright (c) 2024 Seth Hobson; full text in [references/bazel-build-optimization/LICENSE](bazel-build-optimization/LICENSE). Previously redistributed in Skillry as `community/wshobson-agents/skills/bazel-build-optimization`; merged into `monorepo-turborepo-review` in Skillry 3.0.0.
>
...
>
> **Former description:** Optimize Bazel builds for large-scale monorepos. Use when configuring Bazel, implementing remote execution, or optimizing build performance for enterprise codebases.
>
