...
> **Third-party content.** `monorepo-management` from [wshobson/agents](https://github.com/wshobson/agents), upstream path `plugins/developer-essentials/skills/monorepo-management/SKILL.md`. MIT License, Copyright (c) 2024 Seth Hobson; full text in [references/monorepo-management/LICENSE](monorepo-management/LICENSE). Previously redistributed in Skillry as `community/wshobson-agents/skills/monorepo-management`; merged into `monorepo-turborepo-review` in Skillry 3.0.0.
>
> Skillry copy imported 2026-05-31; upstream has since restructured this skill, so the text below is the Skillry copy, not current upstream `main`.
>
> **Former description:** Master monorepo management with Turborepo, Nx, and pnpm workspaces to build efficient, scalable multi-package repositories with optimized builds and dependency management. Use when setting up monorepos, optimizing builds, or managing shared dependencies.
>
> **Edits on merge:** frontmatter replaced by this header; the vendor-import note folded into this header.
