...
> **Third-party content.** `nx-workspace-patterns` from [wshobson/agents](https://github.com/wshobson/agents), upstream path `plugins/developer-essentials/skills/nx-workspace-patterns/SKILL.md`. MIT License, Copyright (c) 2024 Seth Hobson; full text in [references/nx-workspace-patterns/LICENSE](nx-workspace-patterns/LICENSE). Previously redistributed in Skillry as `community/wshobson-agents/skills/nx-workspace-patterns`; merged into `monorepo-turborepo-review` in Skillry 3.0.0.
>
...
>
> **Former description:** Configure and optimize Nx monorepo workspaces. Use when setting up Nx, configuring project boundaries, optimizing build caching, or implementing affected commands.
>
