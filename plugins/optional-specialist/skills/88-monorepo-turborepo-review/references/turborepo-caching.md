...
> **Third-party content.** `turborepo-caching` from [wshobson/agents](https://github.com/wshobson/agents), upstream path `plugins/developer-essentials/skills/turborepo-caching/SKILL.md`. MIT License, Copyright (c) 2024 Seth Hobson; full text in [references/turborepo-caching/LICENSE](turborepo-caching/LICENSE). Previously redistributed in Skillry as `community/wshobson-agents/skills/turborepo-caching`; merged into `monorepo-turborepo-review` in Skillry 3.0.0.
>
...
>
> **Former description:** Configure Turborepo for efficient monorepo builds with local and remote caching. Use when setting up Turborepo, optimizing build pipelines, or implementing distributed caching.
>
