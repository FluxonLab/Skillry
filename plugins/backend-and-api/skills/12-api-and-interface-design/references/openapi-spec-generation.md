> **Merged skill:** `openapi-spec-generation` is part of `api-and-interface-design` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [wshobson/agents](https://github.com/wshobson/agents) `plugins/documentation-generation/skills/openapi-spec-generation/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/wshobson-agents/skills/openapi-spec-generation/SKILL.md`.
> **License:** MIT, Copyright (c) 2024 Seth Hobson. Full text: [`references/openapi-spec-generation/LICENSE`](openapi-spec-generation/LICENSE).
...
> **Former description:** Generate and maintain OpenAPI 3.1 specifications from code, design-first specs, and validation patterns. Use when creating API documentation, generating SDKs, or ensuring API contract compliance.
...
For advanced code-first generation patterns and tooling, see [references/openapi-spec-generation/references/code-first-and-tooling.md](openapi-spec-generation/references/code-first-and-tooling.md):
