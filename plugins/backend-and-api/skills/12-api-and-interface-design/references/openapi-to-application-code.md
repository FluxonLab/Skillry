> **Merged skill:** `openapi-to-application-code` is part of `api-and-interface-design` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [github/awesome-copilot](https://github.com/github/awesome-copilot) `skills/openapi-to-application-code/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/github-awesome-copilot/skills/openapi-to-application-code/SKILL.md`.
> **License:** MIT, Copyright GitHub, Inc. Full text: [`references/openapi-to-application-code/LICENSE`](openapi-to-application-code/LICENSE).
> **Changes:** YAML frontmatter replaced by this header (and the former vendor-import note); body unchanged.
> **Former description:** Generate a complete, production-ready application from an OpenAPI specification
