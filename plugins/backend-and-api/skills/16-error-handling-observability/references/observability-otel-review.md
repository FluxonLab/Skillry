> **Merged skill:** `observability-otel-review` is part of `error-handling-observability` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** Skillry original, formerly `plugins/optional-specialist/skills/87-observability-otel-review/SKILL.md`.
> **Changes:** YAML frontmatter replaced by this header; body unchanged.
> **Former description:** Use when you need to review OpenTelemetry, logs, metrics, traces, dashboards, and operational diagnostics.
