> **Merged skill:** `python-pypi-package-builder` is part of `python-project-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [github/awesome-copilot](https://github.com/github/awesome-copilot) `skills/python-pypi-package-builder/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/github-awesome-copilot/skills/python-pypi-package-builder/SKILL.md`.
> **License:** MIT, Copyright GitHub, Inc. Full text: [`references/python-pypi-package-builder/LICENSE`](python-pypi-package-builder/LICENSE).
> **Changes:** YAML frontmatter replaced by this header (and the former vendor-import note); paths to its references and scaffold script re-pointed to the new layout (paths in backticks are relative to the skill directory).
> **Former description:** End-to-end skill for building, testing, linting, versioning, and publishing a production-grade Python library to PyPI. Covers all four build backends (setuptools+setuptools_scm, hatchling, flit, poetry), PEP 440 versioning, semantic versioning, dynamic git-tag versioning, OOP/SOLID design, type hints (PEP 484/526/544/561), Trusted Publishing (OIDC), and the full PyPA packaging flow. Use for: creating Python packages, pip-installable SDKs, CLI tools, framework plugins, pyproject.toml setup, py.typed, setuptools_scm, semver, mypy, pre-commit, GitHub Actions CI/CD, or PyPI publishing.
...
|---|---|
| `references/python-pypi-package-builder/references/pyproject-toml.md` | All four backend templates, `setuptools_scm`, `py.typed`, tool configs |
| `references/python-pypi-package-builder/references/library-patterns.md` | OOP/SOLID, type hints, core class design, factory, protocols, CLI |
| `references/python-pypi-package-builder/references/testing-quality.md` | `conftest.py`, unit/backend/async tests, ruff/mypy/pre-commit |
| `references/python-pypi-package-builder/references/ci-publishing.md` | `ci.yml`, `publish.yml`, Trusted Publishing, TestPyPI, CHANGELOG, release checklist |
| `references/python-pypi-package-builder/references/community-docs.md` | README, docstrings, CONTRIBUTING, SECURITY, anti-patterns, master checklist |
| `references/python-pypi-package-builder/references/architecture-patterns.md` | Backend system (plugin/strategy), config layer, transport layer, CLI, backend injection |
| `references/python-pypi-package-builder/references/versioning-strategy.md` | PEP 440, SemVer, pre-release, setuptools_scm deep-dive, flit static, decision engine |
| `references/python-pypi-package-builder/references/release-governance.md` | Branch strategy, branch protection, OIDC, tag author validation, prevent invalid tags |
| `references/python-pypi-package-builder/references/tooling-ruff.md` | Ruff-only setup (replaces black/isort), mypy config, pre-commit, asyncio_mode=auto |

**Scaffold script:** run `python scripts/python-pypi-package-builder/scaffold.py --name your-package-name`
...
For implementation patterns of each type, see `references/python-pypi-package-builder/references/library-patterns.md`.
...
For all four complete `pyproject.toml` templates, see `references/python-pypi-package-builder/references/pyproject-toml.md`.
...
For complete CI workflow and publishing setup, see `references/python-pypi-package-builder/references/ci-publishing.md`.
...
For complete pyproject.toml templates for all four backends, see `references/python-pypi-package-builder/references/pyproject-toml.md`.
...
1. **Set up `pyproject.toml`** → `references/python-pypi-package-builder/references/pyproject-toml.md`
   All four backend templates (setuptools+scm, hatchling, flit, poetry), full tool configs,
   `py.typed` setup, versioning config.

2. **Write your library code** → `references/python-pypi-package-builder/references/library-patterns.md`
...
3. **Add tests and code quality** → `references/python-pypi-package-builder/references/testing-quality.md`
   `conftest.py`, unit/backend/async tests, parametrize, ruff/mypy/pre-commit setup.

4. **Set up CI/CD and publish** → `references/python-pypi-package-builder/references/ci-publishing.md`
   `ci.yml`, `publish.yml` with Trusted Publishing (OIDC, no API tokens), CHANGELOG format,
   release checklist.

5. **Polish for community/OSS** → `references/python-pypi-package-builder/references/community-docs.md`
   README sections, docstring format, CONTRIBUTING, SECURITY, issue templates, anti-patterns
   table, and master release checklist.

6. **Design backends, config, transport, CLI** → `references/python-pypi-package-builder/references/architecture-patterns.md`
...
7. **Choose and implement a versioning strategy** → `references/python-pypi-package-builder/references/versioning-strategy.md`
...
8. **Govern releases and secure the publish pipeline** → `references/python-pypi-package-builder/references/release-governance.md`
...
9. **Simplify tooling with Ruff** → `references/python-pypi-package-builder/references/tooling-ruff.md`
