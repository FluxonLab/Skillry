> **Merged skill:** `async-python-patterns` is part of `python-project-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [wshobson/agents](https://github.com/wshobson/agents) `plugins/python-development/skills/async-python-patterns/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/wshobson-agents/skills/async-python-patterns/SKILL.md`.
> **License:** MIT, Copyright (c) 2024 Seth Hobson. Full text: [`references/async-python-patterns/LICENSE`](async-python-patterns/LICENSE).
> **Changes:** YAML frontmatter replaced by this header (and the former vendor-import note); body unchanged.
> **Former description:** Master Python asyncio, concurrent programming, and async/await patterns for high-performance applications. Use when building async APIs, concurrent systems, or I/O-bound applications requiring non-blocking operations.
