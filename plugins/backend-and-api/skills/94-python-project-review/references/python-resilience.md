> **Merged skill:** `python-resilience` is part of `python-project-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [wshobson/agents](https://github.com/wshobson/agents) `plugins/python-development/skills/python-resilience/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/wshobson-agents/skills/python-resilience/SKILL.md`.
> **License:** MIT, Copyright (c) 2024 Seth Hobson. Full text: [`references/python-resilience/LICENSE`](python-resilience/LICENSE).
> **Changes:** YAML frontmatter replaced by this header (and the former vendor-import note); body unchanged.
> **Former description:** Python resilience patterns including automatic retries, exponential backoff, timeouts, and fault-tolerant decorators. Use when adding retry logic, implementing timeouts, building fault-tolerant services, or handling transient failures.
