> **Merged skill:** `python-design-patterns` is part of `python-project-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [wshobson/agents](https://github.com/wshobson/agents) `plugins/python-development/skills/python-design-patterns/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/wshobson-agents/skills/python-design-patterns/SKILL.md`.
> **License:** MIT, Copyright (c) 2024 Seth Hobson. Full text: [`references/python-design-patterns/LICENSE`](python-design-patterns/LICENSE).
> **Changes:** YAML frontmatter replaced by this header (and the former vendor-import note); Related Skills links re-pointed (python-testing-patterns now lives in test-driven-development; python-project-setup is upstream-only).
> **Former description:** Python design patterns including KISS, Separation of Concerns, Single Responsibility, and composition over inheritance. Use this skill when designing a new service or component from scratch and choosing how to layer responsibilities, when refactoring a God class or monolithic function that has grown too large, when deciding whether to add a new abstraction or live with duplication, when evaluating a pull request for structural issues like tight coupling or leaking internal types, when choosing between inheritance and composition for a new class hierarchy, or when a codebase is becoming hard to test because of entangled I/O and business logic.
...
- `test-driven-development` skill, `references/python-testing-patterns.md` — Test each layer in isolation using the dependency injection structure established here
- `python-project-setup` (upstream wshobson/agents skill, not bundled with Skillry) — Set up project structure and tooling that enforces layer boundaries from the start
