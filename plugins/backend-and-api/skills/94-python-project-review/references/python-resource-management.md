> **Merged skill:** `python-resource-management` is part of `python-project-review` since Skillry 3.0.0 (routing table in `SKILL.md`).
> **Source:** [wshobson/agents](https://github.com/wshobson/agents) `plugins/python-development/skills/python-resource-management/SKILL.md`, redistributed in Skillry since 2026-05-31; formerly `community/wshobson-agents/skills/python-resource-management/SKILL.md`.
> **License:** MIT, Copyright (c) 2024 Seth Hobson. Full text: [`references/python-resource-management/LICENSE`](python-resource-management/LICENSE).
> **Changes:** YAML frontmatter replaced by this header (and the former vendor-import note); body unchanged.
> **Former description:** Python resource management with context managers, cleanup patterns, and streaming. Use when managing connections, file handles, implementing cleanup logic, or building streaming responses with accumulated state.
