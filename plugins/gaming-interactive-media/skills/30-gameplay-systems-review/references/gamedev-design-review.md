...
> Absorbed into `gameplay-systems-review` in Skillry 3.0.0; formerly the standalone skill `gamedev-design-review`.
> Source: [Donchitos/Claude-Code-Game-Studios](https://github.com/Donchitos/Claude-Code-Game-Studios), upstream `.claude/skills/design-review/SKILL.md`; Skillry copy formerly at `community/Donchitos-Claude-Code-Game-Studios/skills/198-gamedev-design-review/SKILL.md`.
> License: MIT, Copyright (c) 2026 Donchitos. The license text is in `references/gamedev-design-review/LICENSE`.
> Slash commands in this text use upstream names; the command map in `SKILL.md` resolves them.

Former frontmatter:

```yaml
name: gamedev-design-review
