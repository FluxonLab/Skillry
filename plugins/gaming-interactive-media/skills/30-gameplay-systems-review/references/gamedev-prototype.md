...
> Absorbed into `gameplay-systems-review` in Skillry 3.0.0; formerly the standalone skill `gamedev-prototype`.
> Source: [Donchitos/Claude-Code-Game-Studios](https://github.com/Donchitos/Claude-Code-Game-Studios), upstream `.claude/skills/prototype/SKILL.md`; Skillry copy formerly at `community/Donchitos-Claude-Code-Game-Studios/skills/215-gamedev-prototype/SKILL.md`.
> License: MIT, Copyright (c) 2026 Donchitos. The license text is in `references/gamedev-prototype/LICENSE`.
> Path map: the upstream path `.claude/docs/director-gates.md` is bundled here as `references/gamedev-brainstorm/references/director-gates.md`.
