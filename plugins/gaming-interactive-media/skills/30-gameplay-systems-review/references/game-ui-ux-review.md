...
> Absorbed into `gameplay-systems-review` in Skillry 3.0.0; formerly the standalone skill `game-ui-ux-review`.
> Origin: Skillry original, former path `plugins/gaming-interactive-media/skills/31-game-ui-ux-review/SKILL.md`.
...
## When not to use
- The issue is purely rendering performance (low frame rate) — use `game-architecture-review` (`references/game-performance-review.md`).
