...
> Absorbed into `game-architecture-review` in Skillry 3.0.0; formerly the standalone skill `phaser-game-development`.
> Origin: Skillry original, former path `plugins/gaming-interactive-media/skills/251-phaser-game-development/SKILL.md`.
