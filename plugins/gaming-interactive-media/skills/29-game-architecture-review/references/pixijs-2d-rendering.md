...
> Absorbed into `game-architecture-review` in Skillry 3.0.0; formerly the standalone skill `pixijs-2d-rendering`.
> Origin: Skillry original, former path `plugins/gaming-interactive-media/skills/253-pixijs-2d-rendering/SKILL.md`.
...
- The project needs a full 2D game engine with physics, input system, and scene manager out of the box — use `references/phaser-game-development.md`.
