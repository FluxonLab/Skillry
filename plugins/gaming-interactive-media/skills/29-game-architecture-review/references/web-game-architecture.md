...
> Absorbed into `game-architecture-review` in Skillry 3.0.0; formerly the standalone skill `web-game-architecture`.
> Origin: Skillry original, former path `plugins/gaming-interactive-media/skills/254-web-game-architecture/SKILL.md`.
...
- The project already commits to Phaser's built-in scene system and state — stay inside Phaser's idioms and use `references/phaser-game-development.md`.
