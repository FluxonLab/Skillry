...
> Absorbed into `game-architecture-review` in Skillry 3.0.0; formerly the standalone skill `web-game-performance`.
> Origin: Skillry original, former path `plugins/gaming-interactive-media/skills/255-web-game-performance/SKILL.md`.
...
- Server-side or Node.js performance — use `backend-latency-profiling` (`references/python-performance-optimization.md`) or equivalent.
...
// PixiJS: use ParticleContainer (see references/pixijs-2d-rendering.md)
