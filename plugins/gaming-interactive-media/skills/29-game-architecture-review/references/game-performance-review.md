...
> Absorbed into `game-architecture-review` in Skillry 3.0.0; formerly the standalone skill `game-performance-review`.
> Origin: Skillry original, former path `plugins/gaming-interactive-media/skills/32-game-performance-review/SKILL.md`.
