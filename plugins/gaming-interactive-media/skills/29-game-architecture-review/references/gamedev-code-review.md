...
> Absorbed into `game-architecture-review` in Skillry 3.0.0; formerly the standalone skill `gamedev-code-review`.
> Source: [Donchitos/Claude-Code-Game-Studios](https://github.com/Donchitos/Claude-Code-Game-Studios), upstream `.claude/skills/code-review/SKILL.md`; Skillry copy formerly at `community/Donchitos-Claude-Code-Game-Studios/skills/190-gamedev-code-review/SKILL.md`.
> License: MIT, Copyright (c) 2026 Donchitos. The license text is in `references/gamedev-code-review/LICENSE`.
