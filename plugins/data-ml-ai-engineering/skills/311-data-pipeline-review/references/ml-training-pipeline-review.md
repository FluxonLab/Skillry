...
> Absorbed into `data-pipeline-review` in Skillry 3.0.0; formerly the standalone skill `ml-training-pipeline-review`.
> Origin: Skillry original, former path `plugins/data-ml-ai-engineering/skills/313-ml-training-pipeline-review/SKILL.md`.
...
- The work is serving an already-trained model — use `references/model-serving-and-inference.md`.
- The change is dataset versioning/lineage metadata only — use `references/dataset-versioning-and-lineage.md`.
- The artifact is an exploratory notebook with no training intent — use `references/notebook-hygiene.md`.
