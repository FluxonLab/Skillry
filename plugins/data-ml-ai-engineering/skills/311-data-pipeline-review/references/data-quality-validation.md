...
> Absorbed into `data-pipeline-review` in Skillry 3.0.0; formerly the standalone skill `data-quality-validation`.
> Origin: Skillry original, former path `plugins/data-ml-ai-engineering/skills/312-data-quality-validation/SKILL.md`.
...
- The concern is purely pipeline orchestration/idempotency — use the main `SKILL.md` procedure (data-pipeline-review).
- The concern is model metric quality (accuracy/drift) rather than input data — use `references/model-serving-and-inference.md`.
