...
> Absorbed into `data-pipeline-review` in Skillry 3.0.0; formerly the standalone skill `dataset-versioning-and-lineage`.
> Origin: Skillry original, former path `plugins/data-ml-ai-engineering/skills/316-dataset-versioning-and-lineage/SKILL.md`.
...
- The concern is in-pipeline data quality assertions — use `references/data-quality-validation.md`.
- The concern is the orchestration/idempotency of the pipeline — use the main `SKILL.md` procedure (data-pipeline-review).
