...
> Absorbed into `data-pipeline-review` in Skillry 3.0.0; formerly the standalone skill `notebook-hygiene`.
> Origin: Skillry original, former path `plugins/data-ml-ai-engineering/skills/315-notebook-hygiene/SKILL.md`.
...
- The work is a production training pipeline already in `.py` form — use `references/ml-training-pipeline-review.md`.
- The concern is dataset versioning rather than notebook discipline — use `references/dataset-versioning-and-lineage.md`.
