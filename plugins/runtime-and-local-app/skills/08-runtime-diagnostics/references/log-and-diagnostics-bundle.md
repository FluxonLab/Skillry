...
> **Merged reference.** Former Skillry skill `log-and-diagnostics-bundle` (`plugins/runtime-and-local-app/skills/11-log-and-diagnostics-bundle/SKILL.md`, Skillry original), merged into `runtime-diagnostics` in Skillry 3.0.0.
>
> **Former description:** Use when you need to collect concise logs, environment facts, versions, and failure evidence without exposing secrets.
>
