...
> **Merged reference.** Former Skillry skill `agent-supply-chain-review` (`plugins/ai-and-agent-systems/skills/46-agent-supply-chain-review/SKILL.md`, Skillry original), merged into `dependency-supply-chain-review` in Skillry 3.0.0.
>
> **Former description:** Use when you need to review third-party agents, skills, plugins, prompts, install scripts, and provenance.
>
...
- The review is about runtime permission controls rather than component provenance (use `ai-security-review`, its `references/agent-governance-review.md`).
