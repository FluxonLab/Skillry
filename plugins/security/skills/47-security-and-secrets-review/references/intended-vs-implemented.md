...
> **Third-party content.** `intended-vs-implemented` from [phuryn/pm-skills](https://github.com/phuryn/pm-skills), path `pm-ai-shipping/skills/intended-vs-implemented/` at commit `8607e3b077817f89bf4a9b623246219734ac3be0` (the reviewed local copy was byte-identical to it on 2026-09-19). MIT License, Copyright (c) 2026 Pawel Huryn; full text in [references/intended-vs-implemented/LICENSE](intended-vs-implemented/LICENSE). Imported into Skillry 3.0.0 as part of `security-and-secrets-review`.
>
> Upstream plugin `pm-ai-shipping` 2.1.0 declares `license: MIT`. The body mentions a `shipping-artifacts` skill from the same upstream plugin; Skillry does not bundle it.
>
> **Former description:** The method for finding the gap between what a system is supposed to do and what the code actually does — the class of bug generic scanners miss because they have no model of intent. Defines what counts as documented intent, what counts as implementation evidence, which mismatches matter, and how to avoid hand-wavy findings. Use when auditing AI-built code, reviewing access control against documented permissions, or checking whether a codebase matches its own documentation.
>
> **Edits on merge:** frontmatter replaced by this header.
