...
> **Reference of `frontend-performance-budget`.** Formerly the standalone skill `core-web-vitals`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [addyosmani/web-quality-skills](https://github.com/addyosmani/web-quality-skills); previously `community/addyosmani-web-quality-skills/skills/core-web-vitals/`.
> - License: MIT, Copyright (c) 2026 Addy Osmani (upstream `LICENSE` checked 2026-09-19, blob 90715bb4, identical to the vendored copy); copy kept at [core-web-vitals/LICENSE](core-web-vitals/LICENSE).
> - Earlier Skillry import: vendored from `addyosmani-web-quality-skills` on 2026-05-31.
> - Consolidation changes: frontmatter moved into this header; the link to the sibling upstream skill `performance` (never vendored) now points to the upstream repository; body otherwise unchanged.
...
- [Performance skill](https://github.com/addyosmani/web-quality-skills/tree/main/skills/performance) (upstream skill, not vendored)
