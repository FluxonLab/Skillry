...
> **Reference of `web-design-review`.** Formerly the standalone skill `responsive-layout-review`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: Skillry original; previously `plugins/frontend-web-design/skills/23-responsive-layout-review/`. License: MIT (Skillry repository `LICENSE`).
...
- The request is about design quality on a single viewport with no responsive concern — use the hub procedure in [../SKILL.md](../SKILL.md) (`web-design-review`).
...
- The request is about final pixel polish rather than layout correctness — use `visual-polish-pass` ([reference](visual-polish-pass.md)).
