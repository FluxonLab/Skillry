...
> **Reference of `web-design-review`.** Formerly the standalone skill `visual-polish-pass`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: Skillry original; previously `plugins/frontend-web-design/skills/24-visual-polish-pass/`. License: MIT (Skillry repository `LICENSE`).
...
- The layout has structural problems (wrong hierarchy, broken mobile) — fix structure with the hub procedure in [../SKILL.md](../SKILL.md) (`web-design-review`) or `responsive-layout-review` ([reference](responsive-layout-review.md)) first, then polish.
...
- Token architecture or duplicate primitives are the concern — use `design-system-review` ([reference](design-system-review.md)).
