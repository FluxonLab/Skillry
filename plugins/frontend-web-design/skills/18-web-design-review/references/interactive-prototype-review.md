...
> **Reference of `web-design-review`.** Formerly the standalone skill `interactive-prototype-review`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: Skillry original; previously `plugins/gaming-interactive-media/skills/33-interactive-prototype-review/`. License: MIT (Skillry repository `LICENSE`).
