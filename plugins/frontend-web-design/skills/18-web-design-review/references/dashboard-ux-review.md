...
> **Reference of `web-design-review`.** Formerly the standalone skill `dashboard-ux-review`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: Skillry original; previously `plugins/frontend-web-design/skills/21-dashboard-ux-review/`. License: MIT (Skillry repository `LICENSE`).
...
- The request is about final pixel polish of an otherwise-sound layout — use `visual-polish-pass` ([reference](visual-polish-pass.md)).
