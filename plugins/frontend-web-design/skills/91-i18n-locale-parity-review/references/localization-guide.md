...
> **Reference of `i18n-locale-parity-review`.** Formerly the standalone skill `localization-guide`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [SkillMedev/skills](https://github.com/SkillMedev/skills) `skills/localization-guide/SKILL.md` at commit a28c4ce9366b5a8540577bed8f70b6a60f8fde27 (byte-identical, blob 1161a955); imported from a local unmanaged install whose frontmatter name was `Localization Writer`.
> - License: MIT, Copyright (c) 2026 Alexander Ouellet (upstream `LICENSE` checked 2026-09-19, blob 879f1ca4); copy kept at [localization-guide/LICENSE](localization-guide/LICENSE).
> - Note: `ux-writing-audit`, named below, is an upstream sibling skill that Skillry does not ship.
