...
> Absorbed into `database-and-prisma-review` in Skillry 3.0.0; formerly the standalone skill `data-migration-safety`.
> Origin: Skillry original, former path `plugins/database-and-data/skills/37-data-migration-safety/SKILL.md`.
...
- The task is a seed data load, not a schema change (use `references/seed-and-fixture-review.md`).
