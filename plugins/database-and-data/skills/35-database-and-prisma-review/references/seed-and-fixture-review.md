...
> Absorbed into `database-and-prisma-review` in Skillry 3.0.0; formerly the standalone skill `seed-and-fixture-review`.
> Origin: Skillry original, former path `plugins/database-and-data/skills/38-seed-and-fixture-review/SKILL.md`.
...
- The task is a schema migration, not seed data (use `references/data-migration-safety.md`).
