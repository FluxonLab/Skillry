...
> Absorbed into `postgres-supabase-review` in Skillry 3.0.0; formerly the standalone skill `postgresql-table-design`.
> Source: [wshobson/agents](https://github.com/wshobson/agents), upstream `plugins/database-design/skills/postgresql-table-design/SKILL.md`; Skillry copy formerly at `community/wshobson-agents/skills/postgresql-table-design/SKILL.md`, imported 2026-05-31.
> License: MIT, Copyright (c) 2024 Seth Hobson. The license text is in `references/postgresql-table-design/LICENSE`.
