...
> Absorbed into `postgres-supabase-review` in Skillry 3.0.0; formerly the standalone skill `postgresql-optimization`.
> Source: [github/awesome-copilot](https://github.com/github/awesome-copilot), upstream `skills/postgresql-optimization/SKILL.md`; Skillry copy formerly at `community/github-awesome-copilot/skills/postgresql-optimization/SKILL.md`, imported 2026-05-31.
> License: MIT, Copyright GitHub, Inc.. The license text is in `references/postgresql-optimization/LICENSE`.
