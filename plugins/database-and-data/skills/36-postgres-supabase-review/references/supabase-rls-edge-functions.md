...
> Absorbed into `postgres-supabase-review` in Skillry 3.0.0; formerly the standalone skill `supabase-rls-edge-functions`.
> Origin: Skillry original, former path `plugins/database-and-data/skills/257-supabase-rls-edge-functions/SKILL.md`.
