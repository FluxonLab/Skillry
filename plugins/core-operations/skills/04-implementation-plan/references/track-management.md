...
> **Provenance.** Absorbed into `implementation-plan` in Skillry 3.0.0. Formerly the standalone skill `track-management` (`community/wshobson-agents/skills/track-management/SKILL.md`, community source `wshobson-agents`, imported 2026-05-31).
>
> **Upstream:** https://github.com/wshobson/agents `plugins/conductor/skills/track-management/SKILL.md`. **License:** MIT, Copyright (c) 2024 Seth Hobson; full text in `references/track-management/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header.
>
> **Former trigger:** Use this skill when creating, managing, or working with Conductor tracks - the logical work units for features, bugs, and refactors. Applies to spec.md, plan.md, and track lifecycle operations.
>
