...
> **Provenance.** Absorbed into `implementation-plan` in Skillry 3.0.0. Formerly the standalone skill `gamedev-retrospective` (`community/Donchitos-Claude-Code-Game-Studios/skills/220-gamedev-retrospective/SKILL.md`, community source `Donchitos-Claude-Code-Game-Studios`).
>
> **Upstream:** https://github.com/Donchitos/Claude-Code-Game-Studios `.claude/skills/retrospective/SKILL.md`. **License:** MIT, Copyright (c) 2026 Donchitos; full text in `references/gamedev-retrospective/LICENSE`.
>
> **Changes:** frontmatter converted to this header; slash commands name upstream Claude Code Game Studios commands that Skillry does not ship; title heading added (the source file has none).
>
> **Former trigger:** Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration.
>
