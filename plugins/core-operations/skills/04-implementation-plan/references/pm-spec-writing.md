...
> **Provenance.** Absorbed into `implementation-plan` in Skillry 3.0.0. Formerly the standalone skill `pm-spec-writing` (installed outside Skillry; imported in 3.0.0 after the license gate).
>
> **Upstream:** https://github.com/rampstackco/claude-skills `skills/pm-spec-writing/SKILL.md (+ references/)` at commit `3d4510a94a76ead80122c691b5c480f92f3fbe40`. **License:** MIT, Copyright (c) 2026 RampStack Co.; full text in `references/pm-spec-writing/LICENSE`.
>
> **Changes:** frontmatter converted to this header; links to its own files re-pointed under `references/pm-spec-writing/`.
>
> **Note:** `roadmap-planning`, `code-review-web`, `design-standards`, and `ux-research` in When NOT to use are sibling skills of the upstream collection; Skillry does not ship them.
>
> **Former trigger:** Translate ideas, feature requests, or vague concepts into specific, actionable dev briefs. Use this skill whenever the user has an idea they want to build, a feature to spec out, a bug to file, a project to scope, or needs to convert a half-formed idea into a clear implementation brief. Triggers on I want to add, we should build, can we make, what is the plan for, how do we implement, dev brief, feature spec, PRD, user story, acceptance criteria, scope this, prioritize. Also triggers when the user has a list of things they want to build and needs help converting them into well-formed tasks.
>
...
- [`references/pm-spec-writing/references/feature-spec-template.md`](pm-spec-writing/references/feature-spec-template.md) - Full feature spec template.
- [`references/pm-spec-writing/references/dev-brief-template.md`](pm-spec-writing/references/dev-brief-template.md) - Compact dev brief template for tactical work.
- [`references/pm-spec-writing/references/prioritization-frameworks.md`](pm-spec-writing/references/prioritization-frameworks.md) - Beyond impact/effort: RICE, weighted scoring, MoSCoW.
