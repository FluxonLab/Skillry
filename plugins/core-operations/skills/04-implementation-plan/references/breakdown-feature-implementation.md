...
> **Provenance.** Absorbed into `implementation-plan` in Skillry 3.0.0. Formerly the standalone skill `breakdown-feature-implementation` (`community/github-awesome-copilot/skills/breakdown-feature-implementation/SKILL.md`, community source `github-awesome-copilot`, imported 2026-05-31).
>
> **Upstream:** https://github.com/github/awesome-copilot `skills/breakdown-feature-implementation/SKILL.md`. **License:** MIT, Copyright GitHub, Inc.; full text in `references/breakdown-feature-implementation/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header.
>
> **Former trigger:** Prompt for creating detailed feature implementation plans, following Epoch monorepo structure.
