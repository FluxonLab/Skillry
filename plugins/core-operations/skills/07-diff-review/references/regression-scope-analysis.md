...
> **Provenance.** Absorbed into `diff-review` in Skillry 3.0.0. Formerly the standalone skill `regression-scope-analysis` (`plugins/testing-and-qa/skills/54-regression-scope-analysis/SKILL.md`). Origin: Skillry original, MIT (repository `LICENSE`).
>
> **Changes:** frontmatter converted to this header.
>
> **Former trigger:** Use when you need to identify likely regression surfaces, impacted tests, risk boundaries, and verification focus for a code change before merge.
