...
> **Provenance.** Absorbed into `release-readiness-check` in Skillry 3.0.0. Formerly the standalone skill `handoff-readiness-check` (`plugins/devops-and-release/skills/62-handoff-readiness-check/SKILL.md`). Origin: Skillry original, MIT (repository `LICENSE`).
>
> **Changes:** frontmatter converted to this header.
>
> **Former trigger:** Use when you need to check documentation, runbooks, install commands, local startup, tests, and transfer readiness.
