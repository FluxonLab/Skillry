...
> **Provenance.** Absorbed into `release-readiness-check` in Skillry 3.0.0. Formerly the standalone skill `deploy-topology-and-rollback` (`plugins/cloud-and-infrastructure/skills/336-deploy-topology-and-rollback/SKILL.md`). Origin: Skillry original, MIT (repository `LICENSE`).
>
> **Changes:** frontmatter converted to this header.
>
> **Former trigger:** Use when you need to review or design a deployment topology and rollback strategy — blue-green, canary, and rolling deploys, health gates, automated rollback, zero-downtime cutover, and safe infrastructure change sequencing.
