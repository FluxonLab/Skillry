...
> **Provenance.** Absorbed into `release-readiness-check` in Skillry 3.0.0. Formerly the standalone skill `deployment-preflight-review` (`plugins/devops-and-release/skills/60-deployment-preflight-review/SKILL.md`). Origin: Skillry original, MIT (repository `LICENSE`).
>
> **Changes:** frontmatter converted to this header.
>
> **Former trigger:** Use when you need to perform non-deploying deployment readiness checks for env, build, DB, secrets, and rollback.
