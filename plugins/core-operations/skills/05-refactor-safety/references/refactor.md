...
> **Provenance.** Absorbed into `refactor-safety` in Skillry 3.0.0. Formerly the standalone skill `refactor` (`community/github-awesome-copilot/skills/refactor/SKILL.md`, community source `github-awesome-copilot`, imported 2026-05-31).
>
> **Upstream:** https://github.com/github/awesome-copilot `skills/refactor/SKILL.md`. **License:** MIT, Copyright GitHub, Inc.; full text in `references/refactor/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header.
>
> **Former trigger:** Surgical code refactoring to improve maintainability without changing behavior. Covers extracting functions, renaming variables, breaking down god functions, improving type safety, eliminating code smells, and applying design patterns. Less drastic than repo-rebuilder; use for gradual improvements.
>
