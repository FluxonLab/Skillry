...
> **Provenance.** Absorbed into `refactor-safety` in Skillry 3.0.0. Formerly the standalone skill `refactor-method-complexity-reduce` (`community/github-awesome-copilot/skills/refactor-method-complexity-reduce/SKILL.md`, community source `github-awesome-copilot`, imported 2026-05-31).
>
> **Upstream:** https://github.com/github/awesome-copilot `skills/refactor-method-complexity-reduce/SKILL.md`. **License:** MIT, Copyright GitHub, Inc.; full text in `references/refactor-method-complexity-reduce/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header.
>
> **Former trigger:** Refactor given method `${input:methodName}` to reduce its cognitive complexity to `${input:complexityThreshold}` or below, by extracting helper methods.
