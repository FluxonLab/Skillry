...
> **Provenance.** Absorbed into `architecture-review` in Skillry 3.0.0. Formerly the standalone skill `adr-generator` (`plugins/product-docs-and-research/skills/70-adr-generator/SKILL.md`). Origin: Skillry original, MIT (repository `LICENSE`).
>
> **Changes:** frontmatter converted to this header.
>
> **Former trigger:** Use when you need to generate architecture decision records with context, decision, consequences, and alternatives.
