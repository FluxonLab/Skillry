...
It states **project-specific** rules only. The repository-common rules are
inherited from an ancestor `CLAUDE.md` above this repository, which Claude's
traversal reaches, so they are deliberately **not** duplicated here.
