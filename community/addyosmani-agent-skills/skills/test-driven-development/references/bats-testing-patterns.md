...
> **Provenance.** Absorbed into `test-driven-development` in Skillry 3.0.0. Formerly the standalone skill `bats-testing-patterns` (`community/wshobson-agents/skills/bats-testing-patterns/SKILL.md`, community source `wshobson-agents`, imported 2026-05-31).
>
> **Upstream:** https://github.com/wshobson/agents `plugins/shell-scripting/skills/bats-testing-patterns/SKILL.md`. **License:** MIT, Copyright (c) 2024 Seth Hobson; full text in `references/bats-testing-patterns/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header.
>
> **Former trigger:** Master Bash Automated Testing System (Bats) for comprehensive shell script testing. Use when writing tests for shell scripts, CI/CD pipelines, or requiring test-driven development of shell utilities.
