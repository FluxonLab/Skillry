...
> **Provenance.** Absorbed into `test-driven-development` in Skillry 3.0.0. Formerly the standalone skill `javascript-testing-patterns` (`community/wshobson-agents/skills/javascript-testing-patterns/SKILL.md`, community source `wshobson-agents`, imported 2026-05-31).
>
> **Upstream:** https://github.com/wshobson/agents `plugins/javascript-typescript/skills/javascript-testing-patterns/SKILL.md`. **License:** MIT, Copyright (c) 2024 Seth Hobson; full text in `references/javascript-testing-patterns/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header; links to its own files re-pointed under `references/javascript-testing-patterns/`.
>
> **Former trigger:** Implement comprehensive testing strategies using Jest, Vitest, and Testing Library for unit tests, integration tests, and end-to-end testing with mocking, fixtures, and test-driven development. Use when writing JavaScript/TypeScript tests, setting up test infrastructure, or implementing TDD/BDD workflows.
...
For full API integration test examples (supertest + PostgreSQL) and database repository integration tests, see [references/javascript-testing-patterns/references/advanced-testing-patterns.md](javascript-testing-patterns/references/advanced-testing-patterns.md).
...
For complete React component test examples (UserForm, hooks with `renderHook`/`act`), see [references/javascript-testing-patterns/references/advanced-testing-patterns.md](javascript-testing-patterns/references/advanced-testing-patterns.md).
...
For snapshot testing, coverage configuration, test organization patterns, promise testing, and timer mocking, see [references/javascript-testing-patterns/references/advanced-testing-patterns.md](javascript-testing-patterns/references/advanced-testing-patterns.md).
