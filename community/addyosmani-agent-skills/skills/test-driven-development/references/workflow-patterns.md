...
> **Provenance.** Absorbed into `test-driven-development` in Skillry 3.0.0. Formerly the standalone skill `workflow-patterns` (`community/wshobson-agents/skills/workflow-patterns/SKILL.md`, community source `wshobson-agents`, imported 2026-05-31).
>
> **Upstream:** https://github.com/wshobson/agents `plugins/conductor/skills/workflow-patterns/SKILL.md`. **License:** MIT, Copyright (c) 2024 Seth Hobson; full text in `references/workflow-patterns/LICENSE`.
>
> **Changes:** frontmatter converted to this header; vendor import marker folded into this header.
>
> **Former trigger:** Use this skill when implementing tasks according to Conductor's TDD workflow, handling phase checkpoints, managing git commits for tasks, or understanding the verification protocol.
>
