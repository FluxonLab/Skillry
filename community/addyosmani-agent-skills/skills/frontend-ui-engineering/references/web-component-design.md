...
> **Reference of `frontend-ui-engineering`.** Formerly the standalone skill `web-component-design`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [wshobson/agents](https://github.com/wshobson/agents); previously `community/wshobson-agents/skills/web-component-design/`.
> - License: MIT, Copyright (c) 2024 Seth Hobson (upstream `LICENSE` checked 2026-09-19, blob 326f0a55, identical to the vendored copy); copy kept at [web-component-design/LICENSE](web-component-design/LICENSE).
