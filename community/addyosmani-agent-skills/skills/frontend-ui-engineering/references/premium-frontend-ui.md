...
> **Reference of `frontend-ui-engineering`.** Formerly the standalone skill `premium-frontend-ui`; the routing table in [../SKILL.md](../SKILL.md) sends that name and its topics here.
>
> - Origin: third-party, [github/awesome-copilot](https://github.com/github/awesome-copilot) (skill author: Utkarsh Patrikar, https://github.com/utkarsh232005); previously `community/github-awesome-copilot/skills/premium-frontend-ui/`.
> - License: MIT, Copyright GitHub, Inc. (upstream `LICENSE` checked 2026-09-19, blob 89bc5e96, identical to the vendored copy); copy kept at [premium-frontend-ui/LICENSE](premium-frontend-ui/LICENSE).
